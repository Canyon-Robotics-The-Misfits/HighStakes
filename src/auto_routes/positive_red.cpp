...
AUTO_ROUTE(auto_routes::positive_red)
{
    ...
    drive_controller->facePoint(lib15442c::Vec(80, 26), 0_deg_raw, { threshold: 5_deg_raw });
    pros::delay(300);

    // Score on alliance stake
    drive_controller->boomerang(pos(80.5, 16), { max_speed: 100 });
    drive_controller->faceAngle(195_deg, { threshold: 2_deg_raw, });
    ...
    pros::delay(100);
    intake->move(127);
    drive_controller->facePoint(lib15442c::Vec(120, 48), 0_deg_raw, { threshold: 10_deg_raw });
